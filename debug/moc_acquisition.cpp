...
QT_MOC_LITERAL(1, 12, 12), // "refresh_plot"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 18), // "realtime_channel_a"
QT_MOC_LITERAL(4, 45, 16) // "realtime_sfera_a"

    },
    "acquisition\0refresh_plot\0\0realtime_channel_a\0"
    "realtime_sfera_a"
};
...
void acquisition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (acquisition::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&acquisition::refresh_plot)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject acquisition::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_acquisition.data,
      qt_meta_data_acquisition,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void acquisition::refresh_plot(int _t1, int _t2)
{
